module.exports = async d => {
    ...
    let hexTester = new RegExp('/^#[0-9A-F]{6}$', 'i')
    if (!hexTester.test(color) && !colors.includes(color.toUpperCase()) && color !== undefined) return d.throwError.invalid(d, 'color', color)
