module.exports = {
    ...
    run: async (d, func, property) => {
        ...
        else if (getFunction == undefined) return new d.error("invalid", d, 'function name', func)
        ...
        if (prop == undefined) return new d.error("invalid", d, 'function property', property)
